defmodule PentoWeb.AdminDashboardLiveTest do
  ...
  @create_user2_attrs %{email: "test2@test.com", password: "passwordpassword", username: "test2"}

  @create_user3_attrs %{email: "test3@test.com", password: "passwordpassword", username: "test3"}
